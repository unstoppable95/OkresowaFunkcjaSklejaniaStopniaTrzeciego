...
begin
 interval_wynik1:=periodsplinevalue_przed(liczba_wezlow1,przed_x1,przed_f1,przedzialowy_xx,kod_bledu3);
      ...
      begin
          ...
          Memo1.Lines.Append('WYST¥PI£ B£¥D - NIE MO¯NA OBLICZYÆ WARTOŒCI ! ');
    ...
    iends_to_strings(interval_wynik1,lewy1,prawy1);
     ...
     Memo1.Lines.Append('St = ' + IntToStr(kod_bledu3));
      ...
      begin
            Memo1.Lines.Clear();
            ShowMessage('Wystapi³ b³¹d !');
          Memo1.Lines.Append('WYST¥PI£ B£¥D - NIE MO¯NA OBLICZYÆ WSPÓ£CZYNNIKÓW ! ');
          Memo1.Lines.Append('St = ' + IntToStr(kod_bledu3));
      end;
...
begin
  ...
  //wypisanie wartoœci dla arytmetyki przedzia³owej
